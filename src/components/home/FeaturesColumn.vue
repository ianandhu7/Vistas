...
const features = [
  {
    ...
    description: "Expert K-10 guidance in all core subjects.",
    icon: "school",
    bg: "#3B82F6",
  },
  {
    ...
    description: "Animated lessons that make concepts clear.",
    icon: "play_circle",
    bg: "#A855F7",
  },
  {
    ...
    desc: "Learn anytime,\nanywhere",
    description: "High-quality sessions, anytime you need.",
    icon: "videocam",
    bg: "#F97316",
  },
  {
    ...
    description: "Notes & practice PDFs for quick revision.",
    icon: "description",
    bg: "#10B981",
  },
  {
    ...
    description: "Smart tests to track your progress.",
    icon: "check_box",
    bg: "#EF4444",
  },
  {
    ...
    category: "Language",
    desc: "Basic, Advanced &\nBusiness English",
    description: "Build fluency & confidence in English.",
    icon: "mic",
    bg: "#8B5CF6",
  },
  {
    ...
    desc: "From basics to\nreal-world skills",
    description: "Learn coding through hands-on projects.",
    icon: "code",
    bg: "#0EA5E9",
  },
  {
    ...
    description: "Express better & improve body language.",
    icon: "chat",
    bg: "#14B8A6",
  },
  {
    ...
    desc: "Music, Guitar,\nDrawing & more",
    description: "Explore Music, Drawing & more.",
    icon: "palette",
    bg: "#EAB308",
  },
  {
    title: "& MANY MORE",
    category: "Future Skills",
    desc: "Future Skills for\na Bright Future",
    description: "Future Skills for a Bright Future.",
    icon: "more_horiz",
    bg: "#3B2D54",
    textColor: "#ffffff",
  }
...
<template>
  <div class="features-wrapper flex flex-col h-full gap-3 relative">
    ...
    <!-- 2x5 Grid on mobile, 3x3 Grid on desktop -->
    <div class="grid grid-cols-2 md:grid-cols-3 gap-2 flex-grow min-h-0 perspective-container">
      <div 
        v-for="f in features" 
        :key="f.title"
      ...
      >
        <div class="flip-inner">
          ...
          <div 
            class="flip-back backdrop-blur-md rounded-[14px] p-2.5 md:p-4 flex flex-col items-center text-center justify-center h-full w-full overflow-hidden transition-all duration-300"
            :style="{ 
              background: themeStore.theme === 'dark'
          ...
          >
            <p class="text-[9px] md:text-[11px] leading-snug font-bold px-2.5"
               :style="{ color: f.textColor && themeStore.theme === 'dark' ? f.textColor : f.bg }">{{ f.description }}</p>
          </div>
